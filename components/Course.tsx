"use client";
import pic from "../public/astro.jpg";
    ...
    <div>
      ...
      <CardContainer className="inter-var">
        <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-gray-950 dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
          ...
          >
            University of Arizona, Coursera
          </CardItem>
          ...
          <div className="flex justify-between items-center mt-20">
            ...
            <CardItem
              translateZ={20}
              as="button"
              className="px-4 py-2 rounded-xl bg-black dark:bg-gray-950 text-gray-950  text-xs font-bold"
            >
              Join
            </CardItem>
          </div>
